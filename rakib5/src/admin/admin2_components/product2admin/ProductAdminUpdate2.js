...
export default function ProductAdminUpdate2() {
    const { id } = useParams()
    ...
    useEffect(() => {
        axios.get(`http://localhost/rakib5/Backend/product2/getProduct.php?id=${id}`)
            .then((res) => {
    ...
    const SaveProducts2 = () => {
        ...
        axios.post("http://localhost/rakib5/Backend/product2/updateProduct.php", formdata, {
            headers: {
                    ...
                    <div className="container card card-body">
                        <div className='card'>
                            <div className='card-body'>
                                ...
                                <NavLink to={'/admin/products2'} className="btn bg-primary">Products2 List</NavLink><br />
                            </div>
                        </div>
                        ...
                        <div>
                            <table className='table table-bordered'>
                                <tbody>
                                    ...
                                    <tr>
                                        <th colSpan={12}><button className="btn btn sm bg-success" onClick={SaveProducts2}>Save</button></th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
