  ...
  return (
    ...
    <ul className="side-menu">
      ...
      <li>
        <a href="#">
          <i className="bx bx-store-alt" />
          <NavLink to='/admin/product'>Prodcut </NavLink>
        </a>
      </li>
      <li>
        <a href="#">
          <i className="bx bx-store-alt" />
          <NavLink to='/admin/products2'>Products2 </NavLink>
        </a>
      </li>
      ...
      <li>
        <a href="#">
          <i className="bx bx-store-alt" />
          <NavLink to='/admin/chooses'>Choosese </NavLink>
        </a>
      </li>
      ...
      <li>
        <a href="#">
          <i className="bx bx-store-alt" />
          <NavLink to='/admin/popular'>Popular </NavLink>
        </a>
      </li>
      ...
      <li>
        <a href="#">
          <i className="bx bx-store-alt" />
          <NavLink to='/admin/slider'>Testimonials </NavLink>
        </a>
      </li>
      <li>
        <a href="#">
